        ...
        ?>
			...
			<ul class="box-info">
				...
				<li>
					...
					<span class="text">
						<!-- <h3>10</h3> -->
						<p><h3>Total Registrations</h3></p>
						<?php	
							$connection = mysqli_connect("localhost","root","","futsal"); 
							$query = "SELECT fname from register ORDER BY fname";
							$query_run = mysqli_query($connection,$query);
				...
				<div class="order">
					...
					<table>
						...
						<?php
									...
									if($conn){
										$dis_query ="Select fname, email, Contact, password from register";
